...
export default function Component() {
  return (
    <div className="flex h-screen w-full flex-col">
      <header className="flex h-14 items-center justify-between bg-[#121212] px-6 text-black font-semibold">
      ...
      <div className="flex flex-1 overflow-hidden">
        <Sidebar />
        <div className="flex flex-1 flex-col bg-[#121212] text-white">
          <div className="flex flex-1 flex-col items-center justify-center gap-8 p-8">
            ...
            <div className="flex flex-col items-center gap-2">
              <h2 className="text-2xl font-bold">Blinding Lights</h2>
              <p className="text-sm text-[#b3b3b3]">The Weeknd</p>
            </div>
